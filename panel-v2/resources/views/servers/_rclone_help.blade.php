<details class="rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
    ...
    <div class="mt-3 space-y-3">
        ...
        <p class="text-xs text-slate-500 mb-0">
            Панель сохранит токен в БД. Чтобы бэкапы шли в новый аккаунт, после сохранения нажмите
            <strong>«Переустановить restic»</strong> в настройках сервера — токен будет залит на сервер по SSH. Токен — секрет, не публикуйте его.
        </p>
    </div>
</details>
