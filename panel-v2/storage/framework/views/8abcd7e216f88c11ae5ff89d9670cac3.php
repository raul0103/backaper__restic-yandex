...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Backaper'); ?> — Backaper v2</title>
...
<body class="bg-slate-50 text-slate-900 min-h-screen antialiased">
    <nav class="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-2.5 text-slate-900 font-bold text-lg tracking-tight no-underline">
            ...
            <div class="flex items-center gap-1">
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'nav-link-active' : ''); ?>">Панель</a>
                <a href="<?php echo e(route('servers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('servers.*') && !request()->routeIs('servers.create') ? 'nav-link-active' : ''); ?>">Серверы</a>
                <a href="<?php echo e(route('guide')); ?>" class="nav-link <?php echo e(request()->routeIs('guide') ? 'nav-link-active' : ''); ?>">Как пользоваться</a>
                <a href="<?php echo e(route('servers.create')); ?>" class="btn btn-primary ml-2 !py-2 !px-3.5">+ Сервер</a>
            </div>
        </div>
    </nav>
...
<?php /**PATH C:\Users\rshak\Desktop\GIT\backaper__restic-yandex\panel-v2\resources\views/layouts/app.blade.php ENDPATH**/ ?>